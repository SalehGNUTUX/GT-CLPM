...
### 🚀 النظرة العامة
GT-CLPM هو مدير حزم شامل لأنظمة غنو/لينكس، يُتيح إدارة الحزم عبر أشهر مديري الحزم من خلال واجهة رسومية موحدة تدعم كلاً من بيئات GTK (Zenity) وبيئات Qt/KDE (KDialog) مع اكتشاف تلقائي لنوع سطح المكتب.
